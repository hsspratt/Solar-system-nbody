...
star1_posx = np.random.randint(-2*au,2*au,(1,1))
star1_posy = np.random.randint(-2*au,2*au,(1,1))
star1_posz = np.random.randint(maxint/3.6,maxint,(1,1))
star1_pos = np.hstack((star1_posx, star1_posy, star1_posz))

star2_posx = np.random.randint(-2*au,1.5*au,(1,1))
star2_posy = np.random.randint(-2*au,1.5*au,(1,1))
star2_posz = np.random.randint(maxint/3.6,maxint,(1,1))
star2_pos = np.hstack((star2_posx, star2_posy, star2_posz))

star3_posx = np.random.randint(0*au,3*au,(1,1))
star3_posy = np.random.randint(0*au,3*au,(1,1))
star3_posz = np.random.randint(maxint/3.6,maxint,(1,1))
star3_pos = np.hstack((star3_posx, star3_posy, star3_posz))

# =============================================================================
# star2_pos = np.random.randint(maxint/3.6,maxint,(1,3))
# star3_pos = np.random.randint(maxint/3.6,maxint,(1,3))
# =============================================================================

star1_vel = np.random.randint(0, 0.5*v_factor,(1,3))
star2_vel = np.random.randint(0, 1.5*v_factor,(1,3))
star3_vel = np.random.randint(0, 2.5*v_factor,(1,3))
...
objects = [Sun, Earth, Jupiter]# [Sun, Mars, Venus, Mercury, Earth] # [Sun, Earth, Mars, Venus, Mercury] # , Jupiter,Saturn,Neptune,Uranus]
